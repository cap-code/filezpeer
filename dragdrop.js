! function (e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).dragDrop = e()
    }
}(function () {
    return function () {
        ...
        1: [function (e, t, r) {
            ...
            function p() {
                c && l && (c = !1, l.length ? s = l.concat(s) : d = -1, s.length && h())
            }
                ...
                if (!c) {
                    ...
                    l = null, c = !1,
                        function (e) {
                            ...
                            if ((o === f || !o) && clearTimeout) return o = clearTimeout, clearTimeout(e);
                            try {
                                o(e)
                            } catch (t) {
                                try {
        ...
        2: [function (e, t, r) {
            t.exports = function (e, t) {
                ...
                let r;
                return e.addEventListener("dragenter", i, !1), e.addEventListener("dragover", a, !1), e.addEventListener("dragleave", f, !1), e.addEventListener("drop", u, !1),
                    function () {
                        l(), e.removeEventListener("dragenter", i, !1), e.removeEventListener("dragover", a, !1), e.removeEventListener("dragleave", f, !1), e.removeEventListener("drop", u, !1)
                    };
                ...
                function a(n) {
                    if (n.stopPropagation(), n.preventDefault(), t.onDragOver && t.onDragOver(n), n.dataTransfer.items || n.dataTransfer.types) {
                        ...
                        let o, i;
                        if (e.length ? (o = e.filter(e => "file" === e.kind), i = e.filter(e => "string" === e.kind)) : r.length && (o = r.filter(e => "Files" === e), i = r.filter(e => e.startsWith("text/"))), 0 === o.length && !t.onDropText) return;
                ...
                function f(e) {
                    return e.stopPropagation(), e.preventDefault(), t.onDragLeave && t.onDragLeave(e), clearTimeout(r), r = setTimeout(l, 50), !1
                }

                function u(e) {
                    e.stopPropagation(), e.preventDefault(), t.onDragLeave && t.onDragLeave(e), clearTimeout(r), l();
                    const i = {
                            x: e.clientX,
                            y: e.clientY
                        },
                        a = e.dataTransfer.getData("text");
                    if (a && t.onDropText && t.onDropText(a, i), t.onDrop && e.dataTransfer.items) {
                        const r = e.dataTransfer.files,
                            a = Array.from(e.dataTransfer.items).filter(e => "file" === e.kind);
                        ...
                        n(a.map(e => t => {
                            ! function (e, t) {
                                ...
                                if (e.isFile) e.file(r => {
                                    ...
                                    ! function i(a) {
                                        a.readEntries(f => {
                                            f.length > 0 ? (r = r.concat(Array.from(f)), i(a)) : n(r.map(e => t => {
                                                o(e, t)
                                            }), (r, n) => {
                                                r ? t(r) : (n.push({
                                                    fullPath: e.fullPath,
        ...
        3: [function (e, t, r) {
            (function (e) {
                t.exports = function (t, r) {
                    var n, o, i, a = !0;
                    Array.isArray(t) ? (n = [], o = t.length) : (i = Object.keys(t), n = {}, o = i.length);
